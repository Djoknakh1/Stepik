...
def check_correct_data(data):
    ...
    return len(data) == 2 and data[0] is not None and data[1] is not None
...
def get_spent_calories(dist, current_time):
    ...
    hrs = current_time.hour + current_time.minute / 60
...
def accept_package(data):
    ...
    # Запишите результат расчёта сожжённых калорий.
    achievement = get_achievement(dist)  # Запишите выбранное мотивирующее сообщение.
    # Вызовите функцию show_message().
    print(show_message(pack_time, day_steps, dist, spent_calories, achievement))
